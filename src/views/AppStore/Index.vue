...
const products = [
...

  {
    ...
    name: "eid",
    hidden: false,
    intro: "Identity authorization Application based on the BAS blockchain",
...
const line2Apps = [
  {
    ...
    name: "bmail",
    hidden: false,
    intro: "BAS-based encrypted mailbox server",
    labels: ["mac", "linux"],
    type: "app",
    id: 2,
    sort: 3,
  },
  {
    ...
    name: "ninja",
    hidden: false,
    intro: "Encrypted chat application based on BAS blockchain",
    labels: ["ios", "android"],
    type: "app",
    id: 6,
    sort: 5,
